This document lists all the official manuals, datasheets, source repositories, and technical documentation used during the development, Linux kernel configuration, device tree design, and application coding for the DE1-SoC platform.
...
* **Reference repository**: https://github.com/radislavkosijer/de1_soc_joystick_led
* **GIF creation**: https://ezgif.com/